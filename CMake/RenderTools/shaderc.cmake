...
add_executable( ShaderCompiler ${RenderDir}/Src/RenderTools/shaderc.cpp ${RenderDir}/Src/RenderTools/shaderc.h ${RenderDir}/Src/RenderTools/shaderc_glsl.cpp ${RenderDir}/Src/RenderTools/shaderc_hlsl.cpp ${RenderDir}/Src/RenderTools/shaderc_pssl.cpp ${RenderDir}/Src/RenderTools/shaderc_spirv.cpp ${RenderDir}/Src/RenderTools/shaderc_metal.cpp )
# add_executable(shaderc ALIAS ShaderCompiler)
target_compile_definitions( ShaderCompiler PRIVATE "-D_CRT_SECURE_NO_WARNINGS" )
set_target_properties( ShaderCompiler PROPERTIES FOLDER "bgfx/tools" )
target_link_libraries(ShaderCompiler PRIVATE bx bimg RenderVertexLayout RenderShader fcpp glsl-optimizer glslang spirv-cross spirv-tools webgpu)
target_include_directories(ShaderCompiler PUBLIC  ${BGFX_DIR}/3rdparty)

if (ANDROID)
    target_link_libraries(ShaderCompiler PRIVATE log)
elseif (IOS)
	set_target_properties(ShaderCompiler PROPERTIES MACOSX_BUNDLE ON
											 MACOSX_BUNDLE_GUI_IDENTIFIER ShaderCompiler)
endif()
...
function( add_shader ARG_FILE )
	...
	foreach( PLATFORM ${PLATFORMS} )
		...
		list( APPEND COMMANDS COMMAND "$<TARGET_FILE:ShaderCompiler>" ${CMD} )
	endforeach()
...
function( shaderc )
	...
	add_custom_command( OUTPUT ${ARG_OUTPUT}
		...
		COMMAND "$<TARGET_FILE:ShaderCompiler>" ${CLI}
