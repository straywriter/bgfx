...
include( CMake/ConfigureDebugging.cmake )

include( CMake/dear-imgui.cmake )

set(RenderExampleDir ${CMAKE_CURRENT_SOURCE_DIR} CACHE STRING "" )
	...
	if( NOT "${TYPE}" STREQUAL "" )
		...
		if( WIN32 )
			...
			if( NOT "${TYPE}" STREQUAL "COMPUTE" )
				set( DX9_OUTPUT ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/runtime/shaders/dx9/${FILENAME}.bin )
			...
			# dx11
			set( DX11_OUTPUT ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/runtime/shaders/dx11/${FILENAME}.bin )
			if( NOT "${TYPE}" STREQUAL "COMPUTE" )
		...
		if( APPLE )
			# metal
			set( METAL_OUTPUT ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/runtime/shaders/metal/${FILENAME}.bin )
		...
		# essl
		if( NOT "${TYPE}" STREQUAL "COMPUTE" )
			set( ESSL_OUTPUT ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/runtime/shaders/essl/${FILENAME}.bin )
		...
		# glsl
		set( GLSL_OUTPUT ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/runtime/shaders/glsl/${FILENAME}.bin )
		if( NOT "${TYPE}" STREQUAL "COMPUTE" )
		...
		# spirv
		if( NOT "${TYPE}" STREQUAL "COMPUTE" )
			set( SPIRV_OUTPUT ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/runtime/shaders/spirv/${FILENAME}.bin )
		...
		foreach( OUT ${OUTPUTS} )
			...
			list( APPEND COMMANDS COMMAND "$<TARGET_FILE:ShaderCompiler>" ${${OUT}} )
			get_filename_component( OUT_DIR ${${OUT}_OUTPUT} DIRECTORY )
			file( MAKE_DIRECTORY ${OUT_DIR} )
		endforeach()

		file( RELATIVE_PATH PRINT_NAME ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample ${FILE} )
		add_custom_command(
			MAIN_DEPENDENCY
			${FILE}
			OUTPUT
...
function( add_example ARG_NAME )
	...
	list( APPEND ARG_DIRECTORIES "${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/${ARG_NAME}" )
	set( SOURCES "" )
	set( SHADERS "" )
	...
	if( ARG_COMMON )
		...
		target_include_directories( example-${ARG_NAME} PUBLIC ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/common )
		...
		configure_debugging( example-${ARG_NAME} WORKING_DIR ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/runtime )
		if( MSVC )
	...
	if (IOS OR WIN32)
		...
		add_custom_command( TARGET example-${ARG_NAME} COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/runtime/ $<TARGET_FILE_DIR:example-${ARG_NAME}>)
	else()
		# For everything else symlink some folders into our output directory
		add_custom_command( TARGET example-${ARG_NAME} COMMAND ${CMAKE_COMMAND} -E create_symlink ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/runtime/font $<TARGET_FILE_DIR:example-${ARG_NAME}>/font)
		add_custom_command( TARGET example-${ARG_NAME} COMMAND ${CMAKE_COMMAND} -E create_symlink ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/runtime/images $<TARGET_FILE_DIR:example-${ARG_NAME}>/images)
		add_custom_command( TARGET example-${ARG_NAME} COMMAND ${CMAKE_COMMAND} -E create_symlink ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/runtime/meshes $<TARGET_FILE_DIR:example-${ARG_NAME}>/meshes)
		add_custom_command( TARGET example-${ARG_NAME} COMMAND ${CMAKE_COMMAND} -E create_symlink ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/runtime/shaders $<TARGET_FILE_DIR:example-${ARG_NAME}>/shaders)
		add_custom_command( TARGET example-${ARG_NAME} COMMAND ${CMAKE_COMMAND} -E create_symlink ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/runtime/text $<TARGET_FILE_DIR:example-${ARG_NAME}>/text)
		add_custom_command( TARGET example-${ARG_NAME} COMMAND ${CMAKE_COMMAND} -E create_symlink ${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/runtime/textures $<TARGET_FILE_DIR:example-${ARG_NAME}>/textures)
	endif()
...
add_example(
	...
	COMMON
	DIRECTORIES
	${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/common/debugdraw
	${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/common/entry
	${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/common/font
	${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/common/imgui
	${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/common/nanovg
	${CMAKE_CURRENT_SOURCE_DIR}/RenderExample/common/ps
)
